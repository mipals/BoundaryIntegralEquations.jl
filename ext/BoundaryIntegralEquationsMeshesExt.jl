...
"""
function BoundaryIntegralEquations.create_simple_mesh(bem_mesh::Mesh3d)
    return create_simple_mesh(bem_mesh,bem_mesh.shape_function)
end

function BoundaryIntegralEquations.create_simple_mesh(tri_mesh,shape_function::Triangular)
...
function BoundaryIntegralEquations.create_simple_mesh(quad_mesh,shape_function::Quadrilateral)
    # MeshViz only support linear facets. We mimick this by remove 2nd order.
...
"""
function BoundaryIntegralEquations.create_bc_simple_mesh(mesh,boundary_condition_entities,boundary_conditions=true)
...
"""
function BoundaryIntegralEquations.create_vizualization_data(mesh,data)
    return create_vizualization_data(mesh,data,mesh.physics_function)
end
function BoundaryIntegralEquations.create_vizualization_data(mesh,data,physics_function::Triangular)
...
function BoundaryIntegralEquations.create_vizualization_data(mesh,data,physics_function::DiscontinuousTriangular)
